        ...
        if (req.body) {
          if (!req.body.email || !req.body.name || !req.body.password) {
            ...
            User.create(newCustomer, (err, user) => {
              ...
              res.status(200).json({success: true, message: 'Registration customer successfull', id: user._id});
            })
          }
        } else {
          res.status(400).send('Bad request');
        ...
        if (req.body) {
          if (!req.body.email || !req.body.name || !req.body.password || !req.body.avatarUrl) {
            ...
            User.create(newCustomer, (err, user) => {
              ...
              res.status(200).json({success: true, message: 'Registration operator successfull', id: user._id});
            })
          }
        } else {
          res.status(400).send('Bad request');
